...
<%
session.setAttribute("pelicula", "mine");
%>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
	...
	<div class="container">
		...
		<!-- Izquierda -->
		<div class="left">
			<iframe src="https://www.youtube.com/embed/yxrjSE8XddA"
				frameborder="0" allowfullscreen></iframe>

			<div class="movie-box">
				<img
					src="https://static.cinemarkhoyts.com.ar/Images/Posters/362b0b9682619abc4e9c1061663aedb1.jpg?v=00002541"
...
document.getElementById("btnSiguiente").addEventListener("click", function (e) {
    ...
    // Redirigir a Butacas
    window.location.href = "<%=request.getContextPath()%>/butacas/Butacas.jsp";
});
</script>
