...
<%
   ...
   try {
       ...
       PreparedStatement stmt = conn.prepareStatement(
           "SELECT fila, numero FROM asientos_lilo WHERE estado = 'ocupado' AND sala_id = ?"
       );
...
<div class="container">
   ...
   <div class="right">
       <div class="movie-info">
           <img src=../images/8.jpg alt="Llilo">
           <h3>Minecraft</h3>
           <p><strong> Cine- SALA 4</strong></p>
       </div>
       <div class="summary">
   ...
   <div class="button-group">
       <a href="<%=request.getContextPath()%>/salas/sala4.jsp" class="nav-volver">Volver</a>
