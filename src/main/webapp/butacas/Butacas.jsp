...
<%
    ...
    try {
        ...
        PreparedStatement stmt = conn.prepareStatement(
            "SELECT fila, numero FROM asientos_mine WHERE estado = 'ocupado' AND sala_id = ?"
        );
...
<div class="container">
    ...
    <div class="right">
        <div class="movie-info">
            <img src="../images/5.jpg" alt="minecraft">
            <h3>Minecraft</h3>
            <p><strong>CINE / SALA 1</strong></p>
        </div>
    ...
    <div class="button-group">
        <a href="<%=request.getContextPath()%>/salas/sala1.jsp" class="nav-volver">Volver</a>
