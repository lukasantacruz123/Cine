...
public class LoginDaolmp implements LoginDao {
	...
	private static final String queryFindByUser = "SELECT id, usuario, password FROM usuarios where usuario = ?";

	private static final String queryFindByUserAndPassword = "SELECT id, usuario, password FROM usuarios where usuario = ? and password = ?";

	
	private static final String queryList = "SELECT id, usuario, passowrd FROM usuarios";
	
	private static final String queryConsultarUsuario = "SELECT id, usuario, password FROM usuarios where id=?";
